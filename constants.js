module.exports = {
  ...
  commands2 : [
    ...
    {name: 'caprine', title: 'Messenger', img: 'messenger', bg: 'RoyalBlue', cmd: 'onlyone', args: ['caprine']},
    {name: 'messenger', title: 'WhatsApp', img: 'whats', bg: 'ForestGreen', cmd: '/opt/WA-Web-Msg/WA-Web-Msg', args: []},
